...
db.users.insertMany([
    {
        "user_name":"user1",
        "user_id":1,
        "task_submitted":ISODate("2020-10-10T00:00:00.000Z"),
        "company_attended":"google"
    },
    {
        "user_name":"user2",
        "user_id":2,
        "task_submitted":ISODate("2020-10-15T00:00:00.000Z"),
        "company_attended":""
    },
    {
        "user_name":"user3",
        "user_id":3,
        "task_submitted":ISODate("2020-10-19T00:00:00.000Z"),
        "company_attended":"facebook"
    },
    {
        "user_name":"user4",
        "user_id":4,
        "task_submitted":ISODate("2020-10-30T00:00:00.000Z"),
        "company_attended":"microsoft"
    },
    {
        "user_name":"user5",
        "user_id":5,
        "task_submitted":ISODate("2020-10-05T00:00:00.000Z"),
        "company_attended":""
    },
])
...
db.attendance.insertMany([
    {
        "user_id":1,
        "attendence":"50%",
        "absent":ISODate("2020-10-16T00:00:00.000Z")
    }, 
    {
        "user_id":2,
        "attendence":"60%",
        "absent":ISODate("2020-10-10T00:00:00.000Z")
    }, 
    {
        "user_id":3,
        "attendence":"30%",
        "absent":ISODate("2020-10-20T00:00:00.000Z")
    }, 
    {
        "user_id":4,
        "attendence":"80%",
        "absent":ISODate("2020-10-18T00:00:00.000Z")
    }, 
    {
        "user_id":5,
        "attendence":"65%",
        "absent":ISODate("2020-10-01T00:00:00.000Z")
    }, 
    ])
...
db.attendance.aggregate([
    ...
    },
    {
        $match:{
            ...
            "output.task_submitted":{$gte:"15/10/2020" , $lte:"31/10/2020"}
        }
    }
])
